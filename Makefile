...
# hwameistor.io/hwameistor-operator-bundle:$VERSION and hwameistor.io/hwameistor-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= hwameistor.io/hwameistor-operator
...
release: ## release
	...
	${DOCKER_MAKE_CMD} make compile
	${DOCKER_BUILDX_CMD_AMD64} -t ${IMAGE_NAME}:${RELEASE_TAG}-amd64 ${PROJECT_SOURCE_CODE_DIR}
